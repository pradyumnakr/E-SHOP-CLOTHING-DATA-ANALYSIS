...
print("\nThe test accuracy of MLP is: ", accuracy_score(y_test, y_pred))
print("\nThe confusion matrix of MLP is: \n", confusion_matrix(y_test,y_pred))
print("\nThe precision of MLP is: ", precision_score(y_test, y_pred))
print("\nThe recall of MLP is: ", recall_score(y_test,y_pred))

tn, fp, fn, tp = confusion_matrix(y_test, y_pred).ravel()
specificity = tn / (tn + fp)

print("\nThe specificity of MLP is: ", specificity)
print("\nThe f1 score of MLP is: ", f1_score(y_test, y_pred))
...
plt.plot(fpr, tpr, linestyle='--', label='MLP AUC = %0.2f' % roc_auc_score(y_test, y_pred))
